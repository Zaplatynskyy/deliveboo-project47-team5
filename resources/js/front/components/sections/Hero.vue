    ...
    methods: {
        searchRestaurants() {
            ...
            axios
                ...
                .then(function () {
                    ...
                    let restaurant;
                    if(!dataShared.noResultsFound) {
                         restaurant = document.querySelector(".results .title");
                    } else {
                         restaurant = document.querySelector(".no-results h2");
                    }
                    window.scrollTo({
                        top:
                            window.pageYOffset +
        ...
        tagSelected(input_id) {
            ...
            if (tag_input.checked) {
                document
                    .querySelector(`.cross.${input_id}`)
                    .classList.add("d-none");
                document
                    .querySelector(`.check.${input_id}`)
