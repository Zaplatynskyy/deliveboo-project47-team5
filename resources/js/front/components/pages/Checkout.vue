            ...
            <div class="info">
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  :class="{
                    input_error_js: !validation.name.success,
                  }"
                  id="name"
                  name="name"
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  :class="{
                    input_error_js: !validation.cognome.success,
                  }"
                  id="cognome"
                  name="cognome"
            ...
            <div class="contacts">
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  :class="{
                    input_error_js: !validation.address.success,
                  }"
                  id="address"
                  name="address"
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  :class="{
                    input_error_js: !validation.telephone.success,
                  }"
                  id="telephone"
                  name="telephone"
