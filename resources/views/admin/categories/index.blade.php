            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-header">
                        <form class="d-flex justify-content-between align-items-start align-items-md-center create_category" action="{{ route('categories.store') }}" method="POST"
                            enctype="multipart/form-data" id="add_category_form" onsubmit="return validationFormCategory()">
                            ...
                            <div class="w-75">
                                ...
                                <input value="@if (old('formType') == 'create') {{ old('name') }} @endif" type="text"
                                    ...
                                    placeholder="Inserisci la categoria*" name="name" onkeyup="toggleFile(this)">
                                <input type="hidden" name="formType" value="create">
                            </div>
                            <div class="create-img d-none w-25">
                                
                                <label class="m-0">
                                    <input type="file" name="image" title=" "
                                        class="@error('price') is-invalid @enderror"
                                        onchange="previewCreateCategory(event)">
                                </label>
                                <img class="mt-1 mt-xl-0 ml-xl-1 w-50 my_image_create rounded d-none" src=""
                                    alt="">
                            </div>
                            {{-- error js --}}
