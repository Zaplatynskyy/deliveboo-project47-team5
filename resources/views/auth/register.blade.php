                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" id="registration_form" onsubmit="return validationForm()" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="shipping" type="number" class="form-control @error('shipping') is-invalid @enderror" name="shipping" value="{{ old('shipping') }}" step="0.10" min="0.90" max="99.90" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="min_price" type="number" class="form-control @error('min_price') is-invalid @enderror" name="min_price" value="{{ old('min_price') }}" step="0.1" min="0.90" max="99.90" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
